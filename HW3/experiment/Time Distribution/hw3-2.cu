...
int main(int argc, char* argv[]){
    ...
    time = (double)(US_PER_SEC*(t1.tv_sec-start.tv_sec)+(t1.tv_usec-start.tv_usec))/US_PER_SEC;
    printf("Input: %.2lf\n", time);
    ...
    time = (double)(US_PER_SEC*(end.tv_sec-t2.tv_sec)+(end.tv_usec-t2.tv_usec))/US_PER_SEC;
    printf("Output: %.2lf\n", time);
